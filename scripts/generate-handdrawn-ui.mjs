...
const drawings = {
  ...
  widgetLiveClassifier: [
    accent("M10 8 14 8 14 17 10 17Z"),
    p("M10 8C7 7 7 18 10 17M14 8C17 7 17 18 14 17"),
    p("M4 12 7 12M17 12 20 12M5 8 7 10M17 14 19 16", "none", 0.9),
  ],
  widgetClassifier: [
    accent("M4 17 8 13 12 15 18 7 20 9 12 19 8 17 4 21Z"),
    p("M3 20 3 4M3 20 21 20"),
    p("M5 16 8 13 12 15 18 7", "none", 1),
  ],
  widgetTranscription: [
    accent("M6 4 17 4 20 8 19 20 5 20Z"),
    p("M6 4 17 4 20 8 19 20 5 20Z"),
    p("M16 4 16 9 20 9M8 12 16 12M8 15 17 15M8 18 14 18", "none", 0.9),
  ],
  widgetCaption: [
    accent("M5 6 19 6 21 9 19 17 5 17 3 14Z"),
    p("M5 6 19 6 21 9 19 17 5 17 3 14Z"),
    p("M7 11 17 11M7 14 15 14", "none", 1),
  ],
  widgetMarkdown: [
    accent("M6 4 17 4 20 8 19 20 5 20Z"),
    p("M6 4 17 4 20 8 19 20 5 20Z"),
    p(
      "M8.5 14 8.5 10 10 12 11.5 10 11.5 14M13 10 13 14 14.4 14Q16.2 14 16.2 12T14.4 10Z",
      "none",
      0.65,
    ),
  ],
  widgetPdf: [
    ...
    p("M6 4 17 4 20 8 19 20 5 20Z"),
    p(
      "M6.9 14.4 6.9 11.6 8.3 11.6Q9.7 11.6 8.3 13L6.9 13M10.6 11.6 10.6 14.4 12 14.4Q13.4 14.4 13.4 13T12 11.6Z",
      "none",
      0.6,
    ),
    p("M14.8 14.4 14.8 11.6 17.6 11.6M14.8 13 16.7 13", "none", 0.6),
  ],
  desktop: [
  ...
  magic: [
    // Message bubble + AI sparkles (replaces wand)
    accent("M8 8 11 7 13 11 10 14 6 13Z"),
    p("M5 5Q11 2 18 5C23 7 22 13 18 16Q14 18 9 17L4 21 5 15C1 12 1 8 5 5Z"),
    p("M11 7 12.2 10 15 11 12.2 12 11 15 9.8 12 7 11 9.8 10Z", "none", 1.1),
    accent("M18 2 18.8 4.3 21 5 18.8 5.8 18 8 17.2 5.8 15 5 17.2 4.3Z"),
  ],
  // Chat bubble with centered "AI" letterforms
  ai: [
    accent("M5 6 9 5 8 14 5 13Z"),
    p("M4 5Q11 2 19 5C24 8 22 14 17 16Q13 18 8 17L3 21 4 15C1 12 1 8 4 5Z"),
    // A
    p("M7 13.2 9.4 7.2 11.8 13.2M7.7 11.1 11.1 11.1", "none", 1.15),
    // I
    p(
      "M14.6 7.2 14.6 13.2M13.4 7.2 15.8 7.2M13.4 13.2 15.8 13.2",
      "none",
      1.15,
    ),
  ],
